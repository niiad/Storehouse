...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public JSONArray getPurchasesArray(String customer) {
        SQLiteDatabase sqLiteDatabase = getReadableDatabase();

        JSONArray jsonArray = new JSONArray();

        String query = "select * from " + purchasesTableName + " where customer='" + customer + "'";
    ...
    public JSONArray getPurchasesArrayFromDate(String date) {
        SQLiteDatabase sqLiteDatabase = getReadableDatabase();

        JSONArray jsonArray = new JSONArray();

        String query = "select * from " + purchasesTableName + " where date='" + date + "'";
